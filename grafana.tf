...
module "grafana_alb_response_time_bargauge" {
  source        = "git::https://github.com/synapsestudios/terraform-grafana-panel-bar-gauge.git?ref=v1.0.0"
  title         = "Response Time"
  id            = 0
  min           = 0
  max           = 1.5
...
module "grafana_alb_request_response" {
  source = "git::https://github.com/synapsestudios/terraform-grafana-panel-graph.git?ref=v1.0.0"
